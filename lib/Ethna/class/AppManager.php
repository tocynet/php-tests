...
class Ethna_AppManager
{
    ...
    /** @protected  Ethna_Backend       backendオブジェクト */
    protected $backend;

    /** @protected   Ethna_Config        設定オブジェクト */
    protected $config;

    /**  @protected   Ethna_DB      DBオブジェクト */
    protected $db;

    /** @protected   Ethna_I18N          i18nオブジェクト */
    protected $i18n;

    /** @protected   Ethna_ActionForm    アクションフォームオブジェクト */
    protected $action_form;

    /** @protected   Ethna_ActionForm    アクションフォームオブジェクト(省略形) */
    protected $af;

    /** @protected   Ethna_Session       セッションオブジェクト */
    protected $session;
